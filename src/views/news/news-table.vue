  ...
  <div class="className">
    <el-card class="anoCard">
      ...
      <el-table :data="tableData" border stripe>
        ...
        <el-table-column prop="id" width="80" label="新闻id"></el-table-column>
        <el-table-column prop="createdAt" label="新闻时间"></el-table-column>
        <el-table-column
          prop="source"
          label="新闻作者"
          width="90"
...
<script>
import { getNewsPage } from '@/api/table'
export default {
  data() {
    return {
      tableData: [],
  ...
  methods: {
    ...
    _getNewsPage() {
      getNewsPage(this.currentPage, this.pageSize)
        .then(res => {
