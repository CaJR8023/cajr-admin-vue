  ...
  <div class="className">
    <el-card class="anoCard">
      ...
      <el-table :data="tableData" border stripe>
        ...
        <el-table-column prop="tel" width="110" label="手机号"></el-table-column>
        <el-table-column prop="userPref.prefList" label="喜好词列表"></el-table-column>
        <el-table-column
          prop="userInfo.createdAt"
          width="100"
          label="创建时间"
        ></el-table-column>
        <el-table-column prop="userInfo.updatedAt" width="100" label="更新时间"></el-table-column>
