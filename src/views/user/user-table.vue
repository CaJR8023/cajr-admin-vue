  ...
  <div class="className">
    <el-card class="anoCard">
      ...
      <el-table :data="tableData" border stripe>
        ...
        <el-table-column prop="userInfo.avatar" label="头像URL"></el-table-column>
        <el-table-column prop="userInfo.profession" label="职位"></el-table-column>
        <el-table-column prop="userInfo.location" label="住址"></el-table-column>
        <el-table-column prop="userInfo.signature" label="个人签名"></el-table-column>
        <el-table-column
          prop="userInfo.createdAt"
          label="创建时间"
        ></el-table-column>
        <el-table-column prop="userInfo.updatedAt" label="更新时间"></el-table-column>
    ...
    <el-dialog title="修改" :visible.sync="diaIsShow" class="diaForm">
      ...
      >
        ...
        <el-form-item label="作者" prop="address">
          <el-input
            type="text"
            placeholder="请输入新的作者"
        ...
        <el-form-item label="简述" prop="name">
          <el-input
            type="text"
            placeholder="请输入简述"
...
<script>
import { getUserPage } from '@/api/table'
export default {
  data() {
    return {
      tableData: [],
